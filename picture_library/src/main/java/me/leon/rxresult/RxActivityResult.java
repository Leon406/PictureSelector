...
public final class RxActivityResult {
    ...
    static me.leon.rxresult.ActivitiesLifecycleCallbacks activitiesLifecycle;
    ...
    public static void register(final Application application) {
        activitiesLifecycle = new me.leon.rxresult.ActivitiesLifecycleCallbacks(application);
    }
    ...
    public static class Builder<T> {
        ...
        public Observable<Result<T>> startIntent(final Intent intent, @Nullable OnPreResult onPreResult) {
            return startHolderActivity(new me.leon.rxresult.Request(intent), onPreResult);
        }

        private Observable<Result<T>> startHolderActivity(me.leon.rxresult.Request request, @Nullable OnPreResult onPreResult) {
            ...
            Log.i("leon66", "startHolderActivity");
            activitiesLifecycle.getOLiveActivity().subscribe(activity -> {
                Log.i("leon66", "startHolderActivity" + activity);
